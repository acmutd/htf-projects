...
*/
class AndrewT extends Component
{
    render()
    {
        /*
        ...
        */
        ...
        <div id="AndrewT-card">
            ...
            <div id="AndrewT-card-contact-info">
                <h3>Contact Info</h3>
                <ul>
            ...
            <div id="AndrewT-card-about-me">
                <h3>About Me</h3>
                <p>
                    Hello! I'm Andrew Tran, a freshman CS major with a wide variety of interests. Feel free to contact me!
                </p>
            </div>
        </div>
        )
