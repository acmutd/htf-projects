...
*/
class VaughanMcInerneyCard extends Component
{
    render()
    {
        /*
        ...
        */
        return (
        <div id="vaughan-card">
            <span><img id="acm-logo" alt="vaughan Logo" src={"./images/acm-light-alt.png"}/></span>
            ...
            <div id="vaughan-card-contact-info">
                <h3>Contact Info</h3>
                <ul>
            ...
            <div id="vaughan-card-about-me">
                <h3>About Me</h3>
                <p>
                    Hello! This is my business card created for Hacktoberfest.
                </p>
            </div>
        </div>
        )
...
export default VaughanMcInerneyCard;