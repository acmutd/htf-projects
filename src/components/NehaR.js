...
*/
class NehaRCard extends Component
{
    render()
    {
        /*
        ...
        */
        ...
        <div id="NehaR-card">
            ...
            <div id="NehaR-card-contact-info">
            ...
            <div id="NehaR-card-about-me">
                <h3 class="highlight">About Me</h3>
                <p>
                    Hi, I'm Neha Rode and you're watching, Disney Channel!
                </p>
            </div>
        </div>
        )
