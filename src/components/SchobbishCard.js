...
import "./SchobbishCardStyles.css";
...
*/
class SchobbishCard extends Component
{
    render()
    {
        /*
        ...
        */
        return (
        <div id="schobbish-card">
            <span><img id="schobbish-logo" alt="Schobbish Logo" src={"./images/schobbish.jpg"}/></span>
            ...
            <div id="schobbish-card-contact-info">
                <h3>Contact Info</h3>
                <ul>
            ...
            <div id="schobbish-card-about-me">
                <h3>About Me</h3>
                <p>
                    Freshman at The University of Texas at Dallas studying Computer Science
                </p>
            </div>
        </div>
        )
