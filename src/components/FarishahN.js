...
*/
class FarishahN extends Component
{
    render()
    {
        /*
        ...
        */
        ...
        <div id="FarishahN-card">
            ...
            <div id="FarishahN-card-contact-info">
                <h3>Contact Info</h3>
                <ul>
            ...
            <div id="FarishahN-card-about-me">
                <h3>About Me</h3>
                <p>
                    Hello! My name is Farishah N. I am a Computer Science Student at UT Dallas.
                </p>
            </div>
        </div>
        )
