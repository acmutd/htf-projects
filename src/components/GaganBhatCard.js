...
import "./GaganBhatCardStyles.css";
...
*/
class GaganBhatCard extends Component
{
    render()
    {
        /*
        ...
        */
        ...
        <div id="acm-card">
            ...
            <div id="acm-card-about-me">
                <h3>About Me</h3>
                <p>
                Software Development Engineer. AWS Certified Cloud Solutions Architect. Computer Science major at the University of Texas at Dallas. Focused on Cloud Solutions with AWS, Azure, and Salesforce.
