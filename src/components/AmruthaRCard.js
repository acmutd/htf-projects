...
*/
class AmruthaRCard extends Component {
    render() {
        /*
        ...
        */
        return (
            <div id="AmruthaR-card">
                <span><img id="acm-logo" alt="ACM Logo" src={"./images/amrutha.jpg"} /></span>
                ...
                <div id="AmruthaR-card-contact-info">
                    <h3>Contact Info</h3>
                    <ul>
                ...
                <div id="AmruthaR-card-about-me">
                    <h3>About Me</h3>
                    <p>
                        Hello! My name is Amrutha and I love web development. I've been working on Angular but I've been tryiing to learn React.js. I am a huge fan of The Office. I also love playing basketball and tennis!
                </p>
                </div>
            </div>
        )
